...
const chain=[
  ...
  {id:"proc",icon:"⚗️",n:he?"עיבוד כימי":"Chemical Processing",items:he?["HNO₃ ← אוסטוולד","UDMH ← רשיג","RDX/HMX ← בכמן"]:["Ostwald → HNO₃","Raschig → UDMH","Bachmann → RDX/HMX"],c:"#7c3aed",struck:true,strike:he?"מתקני HNO₃ שיראז (2026)":"Shiraz HNO₃ plants (2026)"},
...
return<Sec id="strategic" num="14" title={he?"למה HNO₃ הוא חומר מפתח בייצור טילים?":"Why is HNO₃ a Key Material in Missile Production?"} dark sidebar={<SB color="red" title={he?"🔑 המשמעות":"🔑 Significance"}><p>{he?"פגיעה במתקן אחד לייצור חומצה חנקתית משתקת בו-זמנית ארבע יכולות נשק שונות. לאיראן אין חומר גלם אחר עם השפעה כה רחבה.":"Hitting a single nitric acid plant simultaneously paralyzes four different weapon capabilities. Iran has no other raw material with such broad impact."}</p></SB>}>
  <div style={{padding:24,marginBottom:20,background:P.ink,borderRadius:10,border:`1px solid ${P.gold}30`}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(130px,1fr))",gap:12}}>
      {[{ic:"💧",t:he?"מחמצן IRFNA":"IRFNA Oxidizer",d:he?"IRFNA ← HNO₃ + N₂O₄ + HF. דלק טילים נוזליים: שהאב, גדר, קיאם, עמאד":"IRFNA ← HNO₃ + N₂O₄ + HF. Liquid missiles: Shahab, Ghadr, Qiam, Emad",bg:P.blueS,c:P.blue},
        ...
        {ic:"💣",t:he?"חומרי נפץ":"Explosives",d:he?"RDX/HMX ← HNO₃ + הקסאמין (תהליך בכמן). משמשים בראשי קרב ובדלק מוצק":"HNO₃ + hexamine → RDX/HMX (Bachmann). Used in warheads and solid fuel",bg:P.amberS,c:P.amber},
...
const diagrams=[
  ...
  {name:he?"רשיג — UDMH":"Raschig — UDMH",ic:"🟣",
   render:()=><svg viewBox="0 0 620 420" style={{width:"100%"}}>
    ...
    <text x={435} y={115} textAnchor="middle" fill="#94a3b8" fontSize="5.5">{he?"פסולת ← HCl":"HCl → waste"}</text>
