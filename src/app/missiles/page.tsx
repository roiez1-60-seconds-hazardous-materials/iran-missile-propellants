...
<div style={{display:"flex",justifyContent:"center",gap:8,marginBottom:14,flexWrap:"wrap"}}>
    <button onClick={()=>{const u="https://iran-missile-propellants.vercel.app";const t=he?"60 \u05E9\u05E0\u05D9\u05D5\u05EA \u05D7\u05D5\u05DE\u05B4\u05E1 \u2014 \u05EA\u05D9\u05E7 \u05DE\u05D5\u05D3\u05D9\u05E2\u05D9\u05DF":"60 Seconds HazMat \u2014 Intelligence Dossier";window.open("https://wa.me/?text="+encodeURIComponent(t+"\n"+u),"_blank");}} style={{padding:"8px 16px",borderRadius:8,border:"none",background:"#22c55e",color:"#fff",fontSize:12,fontWeight:700,cursor:"pointer"}}>{he?"\uD83D\uDCAC \u05E9\u05EA\u05E3 \u05D1\u05D5\u05D5\u05D0\u05D8\u05E1\u05D0\u05E4":"\uD83D\uDCAC WhatsApp"}</button>
    <button onClick={()=>{const u="https://iran-missile-propellants.vercel.app";const t=he?"60 \u05E9\u05E0\u05D9\u05D5\u05EA \u05D7\u05D5\u05DE\u05B4\u05E1":"60 Seconds HazMat";window.open("https://t.me/share/url?url="+encodeURIComponent(u)+"&text="+encodeURIComponent(t),"_blank");}} style={{padding:"8px 16px",borderRadius:8,border:"none",background:"#0088cc",color:"#fff",fontSize:12,fontWeight:700,cursor:"pointer"}}>{he?"\u2708\uFE0F \u05D8\u05DC\u05D2\u05E8\u05DD":"\u2708\uFE0F Telegram"}</button>
    <button onClick={()=>navigator.clipboard.writeText("https://iran-missile-propellants.vercel.app")} style={{padding:"8px 16px",borderRadius:8,border:"1px solid rgba(200,164,78,0.3)",background:"rgba(200,164,78,0.1)",color:"#c8a44e",fontSize:12,fontWeight:700,cursor:"pointer"}}>{he?"\uD83D\uDD17 \u05D4\u05E2\u05EA\u05E7 \u05E7\u05D9\u05E9\u05D5\u05E8":"\uD83D\uDD17 Copy Link"}</button>
  </div>
