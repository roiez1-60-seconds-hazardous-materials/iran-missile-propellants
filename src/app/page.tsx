    ...
    <div dir={he ? 'rtl' : 'ltr'} style={{ minHeight: '100vh', background: '#060a14', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 800, margin: '0 auto', padding: '0 20px' }}>
        ...
        <div style={{ textAlign: 'center', padding: '20px 0 40px', borderTop: '1px solid rgba(200,164,78,0.1)' }}>
          {views !== null && <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, marginBottom: 12 }}><span style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>👁️</span><span style={{ fontSize: 13, fontWeight: 700, color: '#c8a44e', fontFamily: 'monospace' }}>{views.toLocaleString()}</span><span style={{ fontSize: 10, color: 'rgba(255,255,255,0.3)' }}>views</span></div>}
