      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 800, margin: '0 auto', padding: '0 20px' }}>
        ...
        <div style={{ textAlign: 'center', padding: '20px 0 40px', borderTop: '1px solid rgba(200,164,78,0.1)' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 8, marginBottom: 14, flexWrap: 'wrap' }}>
            <button onClick={() => { const u = 'https://iran-missile-propellants.vercel.app'; const t = he ? '60 שניות חומ\u05B4ס — איומי הנשק של איראן' : '60 Seconds HazMat — Iran Weapon Threats'; window.open('https://wa.me/?text=' + encodeURIComponent(t + '\n' + u), '_blank'); }} style={{ padding: '8px 16px', borderRadius: 8, border: 'none', background: '#22c55e', color: '#fff', fontSize: 12, fontWeight: 700, cursor: 'pointer' }}>{he ? '💬 שתף בוואטסאפ' : '💬 Share WhatsApp'}</button>
