...
export default function Footer() {
  ...
  return (
    <footer className="relative z-10 border-t border-slate-200 py-12 px-4">
      <div className="max-w-5xl mx-auto text-center space-y-4">
        ...
        <p className="text-sm text-slate-500">
          {lang === 'he'
            ? <>פותח על ידי <strong className="text-slate-700">רועי צוקרמן</strong> — מומחה לחומ״ס וטב״ק</>
            : <>Developed by <strong className="text-slate-700">Roei Zukerman</strong> — HazMat & CBRN Expert</>}
        </p>
        <p className="text-sm text-slate-500">
        </p>
        <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
          <a href="mailto:roiez1@gmail.com" className="text-blue-600 hover:text-blue-600 transition-colors">
            ✉️ roiez1@gmail.com
          </a>
          <a href="https://chat.whatsapp.com/K4NzcZucmimKYFOXE3VVtD?mode=gi_t" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 bg-green-100 text-green-700 border border-green-300 px-4 py-2 rounded-xl hover:bg-green-200 transition-colors font-bold text-xs">
