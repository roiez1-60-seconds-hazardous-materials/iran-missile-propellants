...
const events = [
  ...
  { year:'2017', he:'ח׳ורמשהר — טווח 2,000 ק״מ, ראש קרב 1,500 ק״ג. NTO+UDMH. הנוזלי המדויק ביותר', en:'Khorramshahr — 2,000 km, 1,500 kg warhead. NTO+UDMH. Most accurate liquid missile' },
  ...
  { year:'2/2026', he:'מבצע שאגת האריה — תקיפות South Pars, אספהאן. איראן משגרת מאות טילים לישראל', en:'Operation Roaring Lion — South Pars, Isfahan strikes. Iran launches hundreds of missiles' },
  ...
  return (
    <section id="timeline" className="py-20 px-4 max-w-4xl mx-auto">
      ...
      <div className="relative">
        {/* Vertical line */}
        <div className="absolute top-0 bottom-0 right-6 md:right-8 w-0.5 bg-gradient-to-b from-blue-500/60 via-red-500/40 to-amber-500/60" />
        ...
        {events.map((ev, i) => (
          <motion.div
            ...
            className="relative flex items-start mb-6 pr-16 md:pr-20"
          >
            {/* Year badge - positioned on the line */}
            <div className="absolute right-0 md:right-1 top-0 w-12 md:w-14 text-center">
              <div className="bg-blue-900/80 text-blue-300 text-[10px] md:text-xs font-mono font-bold px-1.5 py-1 rounded-lg border border-blue-600/40">
                {ev.year}
              </div>
            </div>

            {/* Content card */}
            <div className="flex-1 rounded-xl border border-slate-700/40 bg-slate-800/60 backdrop-blur-sm p-3 md:p-4 hover:border-blue-500/30 transition-all">
