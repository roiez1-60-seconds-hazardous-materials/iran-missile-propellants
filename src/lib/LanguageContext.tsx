...
const dict: Record<string, Record<Lang, string>> = {
  ...
  'nav.simulation': { he: 'סימולציה', en: 'Simulation' },
  ...
  'hero.title': { he: 'תיק מודיעין טק טי', en: 'Tech-Tactical Intelligence Dossier' },
  ...
  'hero.stat2.num': { he: '10,000', en: '10,000' },
  'hero.stat2.label': { he: 'טילים (הערכה)', en: 'Est. Missiles' },
